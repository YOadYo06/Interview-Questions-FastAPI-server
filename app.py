...
def reset_and_load_db() -> dict[str, Any]:
    ...
    created = {
        "hr": client.get_or_create_collection("hr_questions", embedding_function=ef),
        "tech": client.get_or_create_collection("tech_questions", embedding_function=ef),
        "realworld": client.get_or_create_collection("realworld_problems", embedding_function=ef),
    }
    ...
    _upsert_collection(created["hr"], hr_data, "hr")
    _upsert_collection(created["tech"], tech_data, "tech")
    _upsert_collection(created["realworld"], real_data, "realworld")
...
def load_db_data() -> dict[str, Any]:
    ...
    _upsert_collection(collections["hr"], hr_data, "hr")
    _upsert_collection(collections["tech"], tech_data, "tech")
    _upsert_collection(collections["realworld"], real_data, "realworld")
